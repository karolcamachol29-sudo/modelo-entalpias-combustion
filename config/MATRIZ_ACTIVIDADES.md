...
| **ACT05** | `F2-EDA` | **Descriptores Moleculares y Fisicoquímicos** | **Alcance:** Extracción de features a partir de SMILES y estequiometría.<br>**Input:** SMILES canónicos y ChemPy/RDKit<br>**Criterio:** Matriz $X$ con descriptores moleculares y fisicoquímicos. | `2026-09-19` | `2026-09-26` | `F2-EDA_ACT05_SCR_calculo_descriptores_moleculares_v1.0_FINAL.py` | `Backlog` | `#py`, `@descriptores-moleculares` |
...
| **ACT07** | `F3-MLB` | **Ajuste de Random Forest Regressor** | **Alcance:** Ensamble de árboles sobre descriptores moleculares y fisicoquímicos.<br>**Input:** Matriz de features<br>**Criterio:** $R^2 > 0.95$ en test set con control de sobreajuste. | `2026-10-03` | `2026-10-10` | `F3-MLB_ACT07_SCR_random_forest_regressor_v1.0_FINAL.py` | `Backlog` | `#py`, `@machine-learning` |
...
| **ACT09** | `F5-REP` | **Benchmarking y Comparación con Literatura** | **Alcance:** Análisis comparativo de predicciones frente a benchmarks de literatura.<br>**Input:** Modelos optimizados y datos de literatura<br>**Criterio:** Informe con métricas ($R^2$, $\text{MAE}$, $\text{RMSE}$) contrastadas. | `2026-10-17` | `2026-10-31` | `F5-REP_ACT09_REP_informe_benchmarking_literatura_v1.0_FINAL.pdf` | `Backlog` | `#pdf`, `#tex`, `@documentacion` |
